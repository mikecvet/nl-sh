...
{
  format!("Output the command-line arguments to satisfy the following prompt. 
  ...
  The returned command and arguments must be a valid command on this platform, since not all POSIX platforms have the same command or argument sets and syntax.
